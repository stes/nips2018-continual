""" Noise Adaptation on different Salt and Pepper Noise Models

Stores all results in ``./log/multitask/snp``
"""
...
def build_parser():
    ...
    parser.add_argument('--log', default="./log/multitask/snp", help="Log directory. Will be created if non-existing")
...
if __name__ == '__main__':
    ...
    if args.source == 'noise':
        noisemodels = datasets_shotnoise.noise2clean()
    else:
        noisemodels = datasets_shotnoise.clean2noise()

    data, loader  = datasets_shotnoise.get_dataset(noisemodels, args.batchsize, num_workers = 4)
